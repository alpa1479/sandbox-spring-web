...
class AuthorRepositoryJpaTest {
    ...
    void shouldReturnAllAuthors() {
        Assertions.assertThat(authorRepository.findAll()).isEqualTo(getExpectedAuthors());
    }

    @Test
    @DisplayName("should return author by id")
    void shouldReturnAuthorById() {
        Assertions.assertThat(authorRepository.findById(1L)).isPresent().hasValue(getExpectedAuthor());
    }
    ...
    void shouldUpdateAuthor() {
        ...
        Assertions.assertThat(authorRepository.findById(authorToUpdate.getId())).isPresent().hasValue(authorToUpdate);
    }
    ...
    void shouldDeleteAuthorById() {
        ...
        testEntityManager.flush();
        testEntityManager.clear();
        Assertions.assertThat(authorRepository.findById(1L)).isNotPresent();
    }
