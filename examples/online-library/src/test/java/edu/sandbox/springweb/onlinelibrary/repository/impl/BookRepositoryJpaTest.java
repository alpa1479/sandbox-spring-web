package edu.sandbox.springweb.onlinelibrary.repository.impl;
...
class BookRepositoryJpaTest {
    ...
    void shouldReturnAllBooks() {
        Assertions.assertThat(bookRepository.findAll()).isEqualTo(getExpectedBooks());
    }

    @Test
    @DisplayName("should return book by id")
    void shouldReturnBookById() {
        Assertions.assertThat(bookRepository.findById(1L)).isPresent().hasValue(getExpectedBook());
    }
    ...
    void shouldReturnCommentsByBookId() {
        ...
        Assertions.assertThat(book.map(Book::getComments).orElse(emptyList())).hasSameElementsAs(getExpectedComments());
    }
    ...
    void shouldUpdateBook() {
        ...
        Assertions.assertThat(bookRepository.findById(bookToUpdate.getId())).isPresent().hasValue(bookToUpdate);
    }
